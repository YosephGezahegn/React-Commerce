  ...
  return (
    <>
      <Column className="bg-white_A700 font-poppins items-center mx-[auto] w-[100%]">
        ...
        <Row className="items-center ml-[10px] lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[9px] lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[85%]">
          <Column className="items-center w-[49%]">
            <Img
              src="images/img_placeholder_67.png"
              className="lg:h-[306px] xl:h-[349px] 2xl:h-[393px] 3xl:h-[471px] h-[523px] w-[100%]"
              alt="placeholder"
            />
            <Row className="lg:gap-[18px] xl:gap-[21px] 2xl:gap-[24px] 3xl:gap-[28px] gap-[32px] grid grid-cols-3 items-center justify-center ml-[10px] lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[9px] lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] px-[0] w-[60%]">
              <Img
                src="images/img_placeholder_68.png"
                className="2xl:h-[103px] 3xl:h-[124px] h-[137px] lg:h-[80px] xl:h-[92px] w-[100%]"
                alt="placeholder"
              />
              <Img
          ...
          <Column className="lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] ml-[32px] w-[49%]">
            <Column className="items-center w-[100%]">
              <Column className="w-[100%]">
                ...
                <Column className="items-center lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
                  <Column className="w-[100%]">
                    <Text className="font-bold leading-[normal] lg:text-[32px] xl:text-[37px] 2xl:text-[42px] 3xl:text-[50px] text-[56px] text-gray_800 w-[49%]">
                      Purple Warm <br />
                      Zip Jacket
                    </Text>
                    <Column className="items-center lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
                    ...
                    <Text className="font-normal lg:leading-[18px] xl:leading-[21px] 2xl:leading-[24px] 3xl:leading-[28px] leading-[32.00px] lg:mt-[18px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] mt-[31px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-gray_500 w-[100%]">
            ...
            <Row className="items-center lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] mt-[56px] w-[34%]">
            ...
            <Button
              className="2xl:mt-[42px] 3xl:mt-[50px] flex items-center justify-center lg:mt-[32px] mt-[56px] text-center w-[31%] xl:mt-[37px]"
              onClick={handleNavigate3}
              rightIcon={
                <Img
                  src="images/img_vector.svg"
                  className="w-[24px] ml-[10px] text-center lg:w-[14px] lg:ml-[5px] xl:w-[16px] xl:ml-[6px] 2xl:w-[18px] 2xl:ml-[7px] 3xl:w-[21px] 3xl:ml-[9px]"
                  alt="Vector"
                />
              }
              size="md"
            >
              <div className="common-pointer bg-transparent font-bold lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px]">
                Add to Cart
              </div>
            </Button>
          </Column>
        </Row>
        <Column className="items-center ml-[10px] lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[9px] lg:mt-[106px] xl:mt-[122px] 2xl:mt-[137px] 3xl:mt-[164px] mt-[183px] w-[85%]">
          <Row className="items-center justify-between w-[100%]">
            ...
            <Img
              ...
              className="lg:h-[28px] xl:h-[33px] 2xl:h-[37px] 3xl:h-[44px] h-[48px] w-[7%]"
              alt="button"
            />
          </Row>
          <List
          ...
          >
            <Column className="items-center justify-center w-[100%]">
              <Img
                ...
                alt="placeholder"
              />
              <Column className="items-center lg:mb-[47px] xl:mb-[54px] 2xl:mb-[61px] 3xl:mb-[73px] mb-[81.5px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] w-[48%]">
            ...
            <Column className="items-center justify-center mt-[1px] w-[100%]">
              <Img
                ...
                alt="placeholder"
              />
              <Column className="items-center lg:mb-[11px] xl:mb-[13px] 2xl:mb-[15px] 3xl:mb-[18px] mb-[20px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] w-[36%]">
                <Text className="font-medium lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-[24px] text-gray_800 w-[auto]">
                  Red Flannel
                </Text>
                <Text className="font-medium ml-[10px] lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[9px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-gray_500 w-[auto]">
